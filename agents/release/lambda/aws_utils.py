...
"""
AWS Utilities for the Release Lambda.

Provides cross-account role assumption and SigV4-signed OpenSearch requests
against the metrics cluster (which hosts the release-state indices).
"""
...
def get_opensearch_session():
    ...
    try:
        response = sts_client.assume_role(
            ...
            RoleSessionName='oscar-release-session'
        )
